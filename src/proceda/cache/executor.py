...
from proceda.session import RunSession, ToolCall
...
class RecipeExecutor:
    ...
    async def execute(self, recipe: StepRecipe) -> dict[str, Any]:
        ...
        Does NOT add assistant/tool messages to the session — the caller
        is responsible for adding a summary. This avoids orphaned tool
        messages that confuse the LLM if a later step falls back.
        """
